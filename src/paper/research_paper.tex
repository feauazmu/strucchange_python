...
\title{Structural Changes in Regression Models\thanks{Felipe Augusto Azuero Mutis, Rheinische Friedrich-Wilhelms-Universität Bonn. Email: \href{mailto:s6feazue@uni-bonn.de}{\nolinkurl{s6feazue [at] uni-bonn [dot] de}}.}}
